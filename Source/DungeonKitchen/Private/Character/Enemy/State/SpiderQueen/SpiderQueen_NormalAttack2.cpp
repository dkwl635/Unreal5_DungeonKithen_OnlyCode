...
#include "Character/Enemy/State/SpiderQueen/SpiderQueen_NormalAttack2.h"

#include "Actor/Enemy/BossAttackActor.h"
#include "Kismet/GameplayStatics.h"
#include "Kismet/KismetSystemLibrary.h"

void USpiderQueen_NormalAttack2::StartState()
{
	Super::StartState();
	OwnerBoss->GetAnimInstance()->Montage_Play(PlayMontage);
}

void USpiderQueen_NormalAttack2::Update(float DeltaTime)
{
...
void USpiderQueen_NormalAttack2::OnMontageEnded(UAnimMontage* Montage, bool bInterrupted)
{
...
float USpiderQueen_NormalAttack2::CalculatePatternWeight(EBossStateType PreviousPattern) const
{
	float weight = 10;
...
void USpiderQueen_NormalAttack2::OnAnimNotifyBegin(FName NotifyName,
	const FBranchingPointNotifyPayload& BranchingPointPayload)
{
	if (!OwnerBoss->GetTarget())
		...
		FVector BossLocation = OwnerBoss->GetMesh()->GetBoneLocation(TEXT("FrontLeg3_R"));
